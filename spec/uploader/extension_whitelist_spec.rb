...
describe CarrierWave::Uploader do
  ...
  describe '#cache!' do
    ...
    context "when there is no whitelist" do
      it "does not raise an integrity error if there is no whitelist" do
    ...
    context "when there is a whitelist" do
      it "does not raise an integrity error if there is a whitelist and the file is on it" do
      ...
      it "raises an integrity error if there is a whitelist and the file is not on it" do
      ...
      it "raises an integrity error if there is a whitelist and the file is not on it, using start of string matcher" do
      ...
      it "raises an integrity error if there is a whitelist and the file is not on it, using end of string matcher" do
        allow(@uploader).to receive(:extension_whitelist).and_return(%w(txt))
      ...
      it "compares whitelist in a case insensitive manner when capitalized extension provided" do
        allow(@uploader).to receive(:extension_whitelist).and_return(%w(jpg gif png))
      ...
      it "compares whitelist in a case insensitive manner when lowercase extension provided" do
        allow(@uploader).to receive(:extension_whitelist).and_return(%w(JPG GIF PNG))
      ...
      it "accepts and check regular expressions" do
